...
interface CtStoreMapper : CommonCountMapper, CommonDeleteMapper, CommonInsertMapper<CtStore?>, CommonUpdateMapper {
    ...
    @Results(id="CtStoreResult", value = [
        ...
        Result(column="merchant_sn", property="merchantSn", jdbcType=JdbcType.VARCHAR),
        Result(column="store_sn", property="storeSn", jdbcType=JdbcType.VARCHAR),
        Result(column="rcyg_store_id", property="rcygStoreId", jdbcType=JdbcType.VARCHAR),
        Result(column="rcyg_store_phone", property="rcygStorePhone", jdbcType=JdbcType.VARCHAR),
