 ...
 */
@RestController
@RequestMapping("/hardwaredevice/ctstore")
public class CtStoreController extends BaseController
{
     ...
     * 查询门店列表
     */
    @PreAuthorize("@ss.hasPermi('hardwaredevice:ctstore:list')")
    @GetMapping("/list")
     ...
     * 导出门店列表
     */
    @PreAuthorize("@ss.hasPermi('hardwaredevice:ctstore:export')")
     ...
     * 新增门店
     */
    @PreAuthorize("@ss.hasPermi('hardwaredevice:ctstore:add')")
     ...
     * 修改门店
     */
    @PreAuthorize("@ss.hasPermi('hardwaredevice:ctstore:edit')")
