package com.cloudtimes.common.core.controller;
...
public class BaseController {
    ...
    public String getAppUsername(){ return getAppLoginUser().getUsername();}

    public Long getAppUserId(){ return getAppLoginUser().getUserId();}
}
