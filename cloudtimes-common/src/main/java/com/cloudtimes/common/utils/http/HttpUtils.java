package com.cloudtimes.common.utils.http;
...
//        header.put("connection", "Keep-Alive");
        ...
        return sendGet(url, param, contentType, header);
    }
     ...
     * @return 所代表远程资源的响应结果
     */
    public static String sendJsonPost(String url, String params) throws Exception {
        HashMap<String, String> header = new HashMap<>();
    ...
    public static String sendJsonPost(String url, String params, Map<String, String> header, int readTimeout, int connectTimeout) throws Exception {
        return sendPost(url, params, header, readTimeout, connectTimeout);
    }
    ...
    public static String sendFormPost(String url, Map<String, String> params, Map<String, String> header) {
        ...
        return sendPost(url, sb.toString(), header, 5000, 30000);
    }
...
//        header.put("connection", "Keep-Alive");
        ...
        return sendPost(url, param, header, 5000, 30000);
    }
     ...
     * @return 所代表远程资源的响应结果
     */
    public static String sendPost(String url, String param, Map<String, String> header, int readTimeout, int connectTimeout) {
