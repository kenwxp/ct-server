...
class CtStoreController : BaseController() {
     ...
     * 查询代理门店没有订单统计
     */
    @Operation(summary = "查询代理门店每月订单统计")
