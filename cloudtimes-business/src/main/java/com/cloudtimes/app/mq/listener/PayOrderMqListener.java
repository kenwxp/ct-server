...
@Slf4j
@Component
@RocketMQMessageListener(consumerGroup = "PayOrderMqListener", topic = "${spring.profiles.active}" + RocketMQConstants.CT_PAY_ORDER, messageModel = MessageModel.CLUSTERING)
