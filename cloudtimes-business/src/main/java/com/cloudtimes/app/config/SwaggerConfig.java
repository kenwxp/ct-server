...
public class SwaggerConfig {
    ...
    private List<SecurityScheme> securitySchemes() {
        ...
        apiKeyList.add(new ApiKey("Authorization", "Authorization", io.swagger.v3.oas.models.security.SecurityScheme.In.HEADER.name()));
        return apiKeyList;
    }
    ...
    private ApiInfo apiInfo() {
        ...
        return new ApiInfoBuilder()
                // 设置标题
                .title("标题：云时代系统API_接口文档")
                // 描述
                .description("描述：云时代系统APP-API")
                // 作者信息
                .contact(new Contact(cloudTimesConfig.getName(), null, null))
                // 版本
                .version("版本号:" + cloudTimesConfig.getVersion())
                .build();
    }
}
